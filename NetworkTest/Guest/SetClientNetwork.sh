#!/bin/bash
################################################################################
# SetClientNetwork.sh - ABOS2 Network Configuration Script
################################################################################
# ABOS2 (Client) のネットワーク設定
#   eth0: 192.168.100.2/24 (ABOS1への接続送信)
#   eth1: 192.168.200.2/24 (ABOS1からの応答受信)
...
sleep 1
ip address add 192.168.200.2/24 dev eth1
...
sleep 3
echo "ABOS2: eth0=192.168.100.2/24, eth1=192.168.200.2/24, eth2=auto"
